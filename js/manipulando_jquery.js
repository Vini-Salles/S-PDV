$("#traco-menu").on('mouseover', function() {
    ...
    $("#list-group-flush").attr('style', 'display: block');
...
$("#btn-sanduiche").click(function() {
    ...
    $("#list-group-flush").attr('style', 'display: none');
    $("#footer").attr('style', 'margin-left: 72px!important');
    $("#coluna1").attr('style', 'margin-left: 70px!important');
});

$("#vendas").click(function() {
    $(location).attr('href', 'tela_caixa.html');
});
